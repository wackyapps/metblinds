...
const doubleRollerBlinds = {
  ...
  blindsBanner: {
    ...
    cta: "Shop Now",
    background: "/images/blinds/DoubleRollerBlinds/banner.jpg",
  },
  /**
  ...
  whyChooseBlindsSlider: {
    ...
    features: [
      ...
      },
      {
        ...
        image: "/images/blinds/DoubleRollerBlinds/drb3.jpg",
      },
      {
 ...
 keyFeaures: {
  ...
  chooseYourFabric: {
    ...
    blackoutFabrics: [
      "/images/blinds/fabrics/doubleroller/dark/4.jpg",
      "/images/blinds/fabrics/doubleroller/dark/5.jpg",
      "/images/blinds/fabrics/doubleroller/dark/6.jpg",
      "/images/blinds/fabrics/doubleroller/dark/9.jpg",
      "/images/blinds/fabrics/doubleroller/dark/3.jpg",

   
    ],
    lightoutFabrics: [
      "/images/blinds/fabrics/doubleroller/light/1.jpg",
      "/images/blinds/fabrics/doubleroller/light/2.jpg",
      "/images/blinds/fabrics/doubleroller/light/7.jpg",
      "/images/blinds/fabrics/doubleroller/light/8.jpg",
      "/images/blinds/fabrics/doubleroller/light/10.jpg",
    ],
  },
  /**
   * choose hardware
  ...
  blindsFeatures: {
    ...
    image: "/images/blinds/DoubleRollerBlinds/How It Works.jpg",
    features: [
      {

...
const luxuryRomanShades = {
  slug: "luxury-roman-shades",
  icon: "/icons/blinds/luxury-roman-shades-blinds.svg",
  title: "Luxury Roman Shades",
  description:
    "Luxury roman shades combine classic elegance with premium materials and craftsmanship, offering sophisticated window treatments that enhance your home's aesthetic appeal.",
  ...
  whyChooseBlindsSlider: {
    heading: "Why Choose Luxury Roman Shades",
    features: [
      {
        icon: <WiDaySunny />,
        title: "Light Control",
    ...
    reviews: [
      {
        ...
        date: "2023-10-20",
        comment:
          "The luxury roman shades look absolutely stunning in my dining room. The quality is exceptional!",
      },
      {
        userImage: "/profile-image.jpg",
...
export default luxuryRomanShades;

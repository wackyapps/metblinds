...
const sunscreenBlinds = {
  ...
  blindsBanner: {
    ...
    cta: "Shop Now",
    background: "/images/blinds/SunscreenBlinds/banner.jpg",
  },
  /**
    ...
    features: [
      {
        ...
        image: "/images/blinds/SunscreenBlinds/UV Protection.avif",
      },
      {
        icon: <MdSecurity />,
        title: "Glare Reduction",
        description: "Enhance your comfort by minimizing harmful sunlight and screen reflections.",
        image: "/images/blinds/SunscreenBlinds/Glare Reduction.jpg",
      },
      {
        ...
        image: "/images/blinds/SunscreenBlinds/Maintain Outdoor View.jpg",
      },
      {
        ...
        image: "/images/blinds/SunscreenBlinds/Maintain Outdoor View(1).jpg",
      },
    ],
  },
  /**
 ...
 keyFeaures: {
  ...
  chooseYourFabric: {
    ...
    blackoutFabrics: [
      "/images/blinds/fabrics/sunscreens/dark/5.jpg",
      "/images/blinds/fabrics/sunscreens/dark/2.jpg",
      "/images/blinds/fabrics/sunscreens/dark/4.jpg",
     

   
    ],
    lightoutFabrics: [
      "/images/blinds/fabrics/sunscreens/light/1.jpg",
      "/images/blinds/fabrics/sunscreens/light/6.jpg",
      "/images/blinds/fabrics/sunscreens/light/3.jpg",
  ...
  blindsFeatures: {
    ...
    image: "/images/blinds/SunscreenBlinds/How It Works_.jpg",
    features: [
      {

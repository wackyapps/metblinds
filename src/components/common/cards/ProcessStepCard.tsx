...
const ProcessStepCard: React.FC<{ data: Props }> = ({ data }) => {
  return (
    <div
      className={`group relative flex flex-col items-center justify-center gap-8 rounded bg-transparent p-10 duration-500 after:absolute after:bottom-0 after:left-0 after:z-10 after:h-2 after:w-full after:bg-[#FFA600] after:duration-700 after:content-[''] hover:bg-[#FFA600]`}
    >
      <div
